...
const MenuStatic = () => {
  ...
  const data = productItem.filter((product) => product.id === params, [])[0];
      ...
      <div className='w-full  p-4 max-w-3xl m-auto h-auto flex flex-col sm:flex-row'>
        ...
        <div className='h-full sm:px-6 py-4'>
          ...
          <div className='flex gap-4 w-full my-2'>
            <button
              className='flex justify-center items-center py-1 px-5 border-2 border-solid w-full  min-w-[100px] max-w-[250px] whitespace-nowrap bg-red-600 text-white hover:bg-white hover:text-black font-semibold rounded'
